...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname integrate...) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(define EPSILON 0.1)
