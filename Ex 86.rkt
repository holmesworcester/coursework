...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |Ex 86|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
(define (add-letter e ke)
  (cond
    [(got-space? e) (make-editor (string-append (editor-pre e) ke) (editor-post e))]
    [else e]))
