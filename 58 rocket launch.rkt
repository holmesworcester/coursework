...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |58 rocket launch|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
(check-expect
 (show 53)
 (place-image ROCKET ROCKET-X 38 BACKG))
...
(check-expect (end? (+ -3 YDELTA)) true)
(check-expect (end? (+ -2 YDELTA)) true)
(check-expect (end? (+ -1 YDELTA)) true)
