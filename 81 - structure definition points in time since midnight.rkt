...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |81 - structure definition points in time since midnight|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
