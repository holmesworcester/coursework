...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |75 - compare word function|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
; Letter is a one of:
