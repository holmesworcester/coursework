...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |219|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(check-expect `(("alan" ,(* 2 500))
  ...
  ("dawn" 2300)) (list (list "alan" 1000) (list "barb" 2000) (list 'list "carl" " , the great" 1500) (list "dawn" 2300))) ; missed 'list on my first try
