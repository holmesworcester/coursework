...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |Ex 114-sigs|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define (sigs? s)
  (cond
    [(and (tank? (sigs-tank s)) (ufo? (sigs-ufo s)) (missile-or-not? (sigs-missile s))) #true]
    [else #false]))