...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |328|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require htdp/dir)
...
(define (list-all-paths d) ; need to add a parameter to pass through path or define a local function that takes path prefix.
    (append
