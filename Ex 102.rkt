...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |Ex 102|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
(define firedstart (make-fired tank-m-0 ufostart misslestart))
(define firedupone (make-fired tank-m-0 ufostart missleupone))
