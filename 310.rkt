...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |310|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
; in that node. Otherwise, the function produces #false. We take advantage of how a BST is sorted to minimize
; the number of comparisons.

(check-expect (search-bst tree1 023999999) 'holmes)
(check-expect (search-bst tree1 024999999) 'guillaume)
(check-expect (search-bst tree2 99999999) #f)
