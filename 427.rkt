...
; Note, I think it's unlikely the exercise was asking me to turn tokens into lowercase letters, but it was somewhat unclear so I did anyway.
...
(check-expect (line-lowercase (explode "HEY           ho yo?")) (explode "hey           ho yo?"))

(define (line-lowercase line)
  (local (; the int for "a"
