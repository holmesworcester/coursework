...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |410|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
; by passing (rest alon) to smaller and larger, we guarantee that they will always return a list that is smaller than the one we started with.
