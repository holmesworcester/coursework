...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |74 - time structure to seconds function|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
; interpretation (make-24 time h m s) means that h whole hours have passed since midnight,
