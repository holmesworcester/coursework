...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |78 - three letter words|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
; Letter is a one of:
