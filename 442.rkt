...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |442|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define (solve soe)
  (local (; Equation, Solution -> Solution
          ...
          (define (solve-tri soe)
            (cond
               [(empty? soe) '()]
               [else (solve-1 (first soe) (solve-tri (rest soe)))])))
    ;-IN-
    (solve-tri (triangulate soe))))
