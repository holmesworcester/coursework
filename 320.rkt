...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |320|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define Docs (make-dir 'Docs #t 2 (cons 'read! '())))
(define Code (make-dir 'Code #f 2 (cons 'hang (cons 'draw '()))))
(define Libs (make-dir 'Libs #f 2 (cons Docs (cons Code '()))))
(define Text (make-dir 'Text #f 2 (cons 'part1 (cons 'part2 (cons 'part3 '())))))
(define TS (make-dir 'TS #f 2 (cons Text (cons 'read! (cons Libs '())))))
...
(check-expect (how-many (make-dir #f 2 'Emptydir '())) 0)
