...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |366|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(check-expect (assoc "green" fsm-traffic) "yellow")
(check-error (assoc "violet" fsm-traffic) "next state not found")
