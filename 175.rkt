...
(define (wc f)
   (string-append "The file " f " has " (line-count f) " lines, " (word-count f) " words, and " (1string-count f) " 1strings (characters)."))

; String -> String
; takes in a filename, counts the number of lines

(define (line-count f) "10")

; String -> String
; takes in a filename, counts the number of words

(define (word-count f) "100")

; String -> String
; takes in a filename, counts the number of 1strings (characters)

(define (1string-count f) "1000")
