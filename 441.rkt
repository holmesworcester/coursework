...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |441|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define (triangulate soe)
  (local (; SOE -> SOE
          ...
          ; fix this by shrinking the matrix if all values are leading zeroes.
    ...
    ;-IN-
    (triangulate-firstnotzero (first-not-zero soe))))