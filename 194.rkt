...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |194|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
; NELoP -> Image
; connects the Posns in p in an image and back at the end to another position pos
...
(define (connect-dots p pos)
  (cond
    [(empty? (rest p)) (render-line MT (first p) pos)]
    [else
      (render-line
        (connect-dots (rest p) pos) (first p) (second p))]))
